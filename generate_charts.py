...
ax1.pie(order_counts, labels=order_types, autopct='%1.1f%%', 
        colors=colors, startangle=90)
ax1.set_title('Order Type Distribution', fontweight='bold')

# Top Right: Revenue by Segment
segment_revenue = [1599.93, 2969.62]  # Standard, Premium
bars = ax2.bar(['Standard', 'Premium'], segment_revenue, color=['#FF6B6B', '#4ECDC4'])
...
# Bottom Left: Daily Orders (simulated)
days = ['Jan 15', 'Jan 16', 'Jan 17', 'Jan 18', 'Jan 19', 'Jan 20']
daily_orders = [2, 1, 1, 1, 1, 1]
ax3.plot(days, daily_orders, marker='o', linewidth=2, color='#2E86AB')
ax3.set_title('Daily Order Count', fontweight='bold')
ax3.set_ylabel('Number of Orders')
ax3.tick_params(axis='x', rotation=45)

# Bottom Right: Regional Distribution
regional_counts = [5, 5, 5, 5]
bars = ax4.bar(regions, regional_counts, 
               color=['#FF9999', '#66B2FF', '#99FF99', '#FFCC99'])
